        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageReactionId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileType = table.Column<string>(type: "character varying(21)", maxLength: 21, nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: true),
                    CommunityId = table.Column<Guid>(type: "uuid", nullable: true),
                    Pseudonym = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    JoinStatus = table.Column<int>(type: "integer", nullable: true),
                    ...
                    ChannelId = table.Column<Guid>(type: "uuid", nullable: true),
                    UserProfile_UserId = table.Column<Guid>(type: "uuid", nullable: true),
                    PersonalWebsite = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    TwitterHandle = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    LinkedInProfile = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_CommunityProfileId",
                table: "Posts",
