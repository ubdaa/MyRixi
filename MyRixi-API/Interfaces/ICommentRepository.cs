...
public interface ICommentRepository : IGenericRepository<Comment>
{
    ...
    Task<List<CommentDto>> GetCommentsByPostIdAsync(Guid postId, int page = 0, int pageSize = 10);
    Task<List<CommentDto>> GetCommentsByProfileIdAsync(Guid profileId, int page = 0, int pageSize = 10);
    Task<List<CommentDto>> GetRepliesByCommentIdAsync(Guid commentId, int page = 0, int pageSize = 10);
